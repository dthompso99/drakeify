...
impl PluginRegistry {
    ...
    fn execute_plugin_hook(&self, plugin: &Plugin, hook_name: &str, data: Value) -> Result<Value> {
        ...
        if let Some(ref db) = self.database {
            ctx.with(|ctx| {
                ...
                let clear_session_fn = Function::new(ctx.clone(), move |session_id: String| -> String {
                    ...
                    let account_id = account_id_clone3.borrow().clone();
                ...
                let set_document_fn = Function::new(ctx.clone(), move |namespace: String, key: String, value: String, metadata: String| -> String {
                    ...
                    let account_id = account_id_clone4.borrow().clone();
                ...
                let get_document_fn = Function::new(ctx.clone(), move |namespace: String, key: String| -> String {
                    ...
                    let account_id = account_id_clone5.borrow().clone();
                ...
                let delete_document_fn = Function::new(ctx.clone(), move |namespace: String, key: String| -> String {
                    ...
                    let account_id = account_id_clone6.borrow().clone();
                ...
                let list_documents_fn = Function::new(ctx.clone(), move |namespace: String| -> String {
                    ...
                    let account_id = account_id_clone7.borrow().clone();
        ...
        ctx.with(|ctx| {
            // Inject document namespace for this plugin
            let namespace = format!("plugin:{}", plugin.name);
